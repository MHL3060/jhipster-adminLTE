...
```bash
bower install adf-widget-linklist --save
```
...
```html
<script type="text/javascript" src="bower_components/adf-widget-linklist/dist/adf-widget-linklist.min.js"></script>
```

Define a dependency for the module:

```javascript
angular.module('sample', ['adf', 'adf.widget.linklist']);
```
