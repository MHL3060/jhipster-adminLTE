                    ...
                    rows: [{
                        columns: [{
                                ...
                                widgets: [ {
                                        type: "markdown",
                                        config: {
                                            content: "![scm-manager logo](https://bitbucket.org/sdorra/scm-manager/\w" +
                                            "iki/resources/scm-manager_logo.jpg)\n\nThe easiest way to share and manage " +
                                            "your Git, Mercurial and Subversion repositories over http.\n\n* Very easy installation\n*" +
