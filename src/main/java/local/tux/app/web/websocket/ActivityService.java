package local.tux.app.web.websocket;

import local.tux.app.security.SecurityUtils;
import local.tux.app.web.websocket.dto.ActivityDTO;
...
import static local.tux.app.config.WebsocketConfiguration.IP_ADDRESS;
